"use strict";module.export({default:()=>Person});var validationNameListByComma;module.link("./utils/validationNameListByComma.js",{default(v){validationNameListByComma=v}},0);var validationDataString;module.link("./utils/validationDataString.js",{default(v){validationDataString=v}},1);
